...
new_image :constants.ImageInfo  ={"image_path":image_path,"image": image,"image_shape":{"width": image.shape[1], "height": image.shape[0], "channels": image.shape[2]},"camera_parameters": camera_parameters,"distance":distance}
